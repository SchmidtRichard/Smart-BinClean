<?php
//This for the admin session, create a new session which will carry the infor of the admin authentication
		...
		<div class="navbar"><!-- Create the nav on the top -->
				...
				<div class="pull-right"><a href="/admin/user_registration/logout.php"><!-- Redicrects to logout -->
						...
						<div class="modal-dialog">
						  <div class="modal-content">
							...
							<div class="modal-body">
								  ...
								  <form action="/admin/update_bin_info_from_web_admin.php" method="post"><!-- Takes the info inserted and send through update_bin_info_from_web_admin.php to then be stored into the DB -->
												ID: <br><input type="text" name="id"><br><br>
												Bin type:
												  <select id="type" name="type">
													<option value="Mixed Recycling">Mixed Recycling</option>
				  ...
				  <div class="modal-dialog">
					...
					<!-- Modal body -->
					<div class="modal-body">
						<form action="/admin/delete_from_web_admin.php" method="post"><!-- Takes the info inserted and send through delete_from_web_admin.php to then be stored into the DB -->
				  ...
				  <div class="modal-dialog">
					...
					<!-- Modal body -->
					<div class="modal-body">
						<form action="/admin/solve_a_reported_issue_from_web_admin.php" method="post"><!-- Takes the info inserted and send through solve_a_reported_issue_from_web_admin.php to then be stored into the DB -->
							  ID: <br><input type="text" name="id">
				...
				<div class="modal-dialog">
				  <div class="modal-content">
					...
					<div class="modal-body">
								...
								<form action="/admin/user_registration/delete_user_from_db.php" method="post"><!-- Sends to delete_user_from_db.php -->
